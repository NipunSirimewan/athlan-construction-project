                                            ...
                                            while($vehiclerow=$vehicleResult->fetch_assoc()){
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                    ...
                                                    <td>
                                                            <a href="view_vehicle.php?vehicle_id=<?php echo $vehicle_id;?>" class="btn btn-info">
                                                                <span class="glyphicon glyphicon-search"></span>
                                                                View
                                                            </a>
                                                            ...
                                                            <a href="../controller/vehicle_controller.php?status=delete&vehicle_id=<?php echo $vehicle_id;?>" class="btn btn-danger">
