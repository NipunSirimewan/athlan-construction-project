<?php
    ...
    $projectResult=$driverObj->getAllProjectNumbers();
...
<body>
    ...
    <div class="container">
        ...
        <div>
            ...
            <form action="../controller/driver_controller.php?status=add_driver" method="post" enctype="multipart/form-data">
                <div class="col-md-9">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" style="width:350px;">
                        <select name="pnumber" id="pnumber" class="form-control" required="required">
                                <option value=""></option>
                                <?php
